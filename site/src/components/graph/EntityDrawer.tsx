...
export function EntityDrawer({ node, links, cy, onClose, onNavigateToNode }: EntityDrawerProps) {
  ...
  const sourceArticles: SourceArticle[] = Array.isArray(node.source_articles)
    ? (node.source_articles as unknown as SourceArticle[])
    : [];
  ...
  return (
    <div className="fixed top-14 right-0 bottom-0 z-40 w-full sm:w-[400px] border-l border-border bg-background shadow-2xl flex flex-col">
      {/* Header */}
